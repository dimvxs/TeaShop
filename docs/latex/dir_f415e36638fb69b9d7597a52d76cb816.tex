...
\begin{center}
\leavevmode
\includegraphics[width=175pt]{dir_f415e36638fb69b9d7597a52d76cb816_dep}
\end{center}
\end{figure}


\doxysubsection{Detailed Description}
\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1055}{}\doxysubsection{\texorpdfstring{Chokidar \mbox{[}!\mbox{[}Weekly downloads\mbox{]}(\href{https://img.shields.io/npm/dw/chokidar.svg}{\texttt{https\+://img.\+shields.\+io/npm/dw/chokidar.\+svg}})\mbox{]}(\href{https://github.com/paulmillr/chokidar}{\texttt{https\+://github.\+com/paulmillr/chokidar}})}{Chokidar \mbox{[}!\mbox{[}Weekly downloads\mbox{]}(\href{https://img.shields.io/npm/dw/chokidar.svg}{\texttt{https\+://img.\+shields.\+io/npm/dw/chokidar.\+svg}})\mbox{]}(\href{https://github.com/paulmillr/chokidar}{\texttt{https\+://github.\+com/paulmillr/chokidar}})}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1055}
\begin{quote}
Minimal and efficient cross-\/platform file watching library \end{quote}
\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1056}{}\doxysubsection{\texorpdfstring{Why?}{Why?}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1056}
...
{\bfseries{Sep 2024 update\+:}} v4 is out! It decreases dependency count from 13 to 1, removes support for globs, adds support for ESM / Common.\+js modules, and bumps minimum node.\+js version from v8 to v14. Check out upgrading.\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1057}{}\doxysubsection{\texorpdfstring{Getting started}{Getting started}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1057}
Install with npm\+:
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1058}{}\doxysubsubsubsection{\texorpdfstring{Persistence}{Persistence}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1058}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1059}{}\doxysubsubsubsection{\texorpdfstring{Path filtering}{Path filtering}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1059}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1060}{}\doxysubsubsubsection{\texorpdfstring{Performance}{Performance}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1060}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1061}{}\doxysubsubsubsection{\texorpdfstring{Errors}{Errors}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1061}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1062}{}\doxysubsubsection{\texorpdfstring{Methods \& Events}{Methods \& Events}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1062}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1063}{}\doxysubsubsection{\texorpdfstring{CLI}{CLI}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1063}
Check out third party \href{https://github.com/open-cli-tools/chokidar-cli}{\texttt{chokidar-\/cli}}, which allows to execute a command on each change, or get a stdio stream of change events.\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1064}{}\doxysubsection{\texorpdfstring{Troubleshooting}{Troubleshooting}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1064}
...
\begin{DoxyItemize}
\item Can be solved by using \href{https://www.npmjs.com/package/graceful-fs}{\texttt{graceful-\/fs}}, which can monkey-\/patch native {\ttfamily fs} module used by chokidar\+: {\ttfamily let fs = require(\textquotesingle{}fs\textquotesingle{}); let grfs = require(\textquotesingle{}graceful-\/fs\textquotesingle{}); grfs.\+gracefulify(fs);}
\item Can also be solved by tuning OS\+: {\ttfamily echo fs.\+inotify.\+max\+\_\+user\+\_\+watches=524288 \texorpdfstring{$\vert$}{|} sudo tee -\/a /etc/sysctl.conf \&\& sudo sysctl -\/p}.
\end{DoxyItemize}
\item Exhausted file handles for {\ttfamily fs.\+watch}
\begin{DoxyItemize}
\item Can\textquotesingle{}t seem to be solved by graceful-\/fs or OS tuning
\item It\textquotesingle{}s possible to start using {\ttfamily use\+Polling\+: true}, which will switch backend to resource-\/intensive {\ttfamily fs.\+watch\+File}
\end{DoxyItemize}
\end{DoxyEnumerate}

All fsevents-\/related issues ({\ttfamily WARN optional dep failed}, {\ttfamily fsevents is not a constructor}) are solved by upgrading to v4+.\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1065}{}\doxysubsection{\texorpdfstring{Changelog}{Changelog}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1065}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1066}{}\doxysubsubsection{\texorpdfstring{Upgrading}{Upgrading}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1066}
...
\end{DoxyCode}
\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1067}{}\doxysubsection{\texorpdfstring{Also}{Also}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1067}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

\texorpdfstring{$>$}{>}Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four). This word is also used in other languages like Urdu as (چوکیدار) which is widely used in Pakistan and India.\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1068}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md1068}
