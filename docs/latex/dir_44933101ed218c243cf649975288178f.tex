...
\begin{center}
\leavevmode
\includegraphics[width=285pt]{dir_44933101ed218c243cf649975288178f_dep}
\end{center}
\end{figure}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \mbox{\hyperlink{dir_e356d4fd6885897303ef0faa1188972a}{php}}
\item 
directory \mbox{\hyperlink{dir_d4e5c61a85f20603c6d614bf4e2aad33}{python}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md1640}{}\doxysubsection{\texorpdfstring{flatted}{flatted}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md1640}
...
\DoxyHorRuler{0}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md1641}{}\doxysubsection{\texorpdfstring{Announcement 📣}{Announcement 📣}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md1641}
...
\end{DoxyCode}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md1642}{}\doxysubsection{\texorpdfstring{to\+JSON and from\+JSON}{to\+JSON and from\+JSON}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md1642}
...
\end{DoxyCode}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md1643}{}\doxysubsection{\texorpdfstring{Flatted VS JSON}{Flatted VS JSON}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md1643}
...
Also please note this project serializes and deserializes only data compatible with JSON, so that sockets, or anything else with internal classes different from those allowed by JSON standard, won\textquotesingle{}t be serialized and unserialized as expected.\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md1644}{}\doxysubsubsection{\texorpdfstring{New in V1\+: Exact same JSON API}{New in V1\+: Exact same JSON API}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md1644}
...
\end{DoxyItemize}\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md1645}{}\doxysubsubsection{\texorpdfstring{Compatibility}{Compatibility}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md1645}
All ECMAScript engines compatible with {\ttfamily Map}, {\ttfamily Set}, {\ttfamily Object.\+keys}, and {\ttfamily Array.\+prototype.\+reduce} will work, even if polyfilled.\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md1646}{}\doxysubsubsection{\texorpdfstring{How does it work ?}{How does it work ?}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md1646}
