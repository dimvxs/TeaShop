...
\begin{center}
\leavevmode
\includegraphics[width=175pt]{dir_420b2d72a95384b6cbf97fdfb99bb5c9_dep}
\end{center}
\end{figure}
...
\end{DoxyCode}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1817}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1817}
...
\end{DoxyCode}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1818}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1818}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1819}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily js\+Tokens}}{{\ttfamily js\+Tokens}}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1819}
...
The next match is always directly after the previous.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1820}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily var token = match\+To\+Token(match)}}{{\ttfamily var token = match\+To\+Token(match)}}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1820}
...
Whitespace includes both line terminators and other whitespace.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1821}{}\doxysubsection{\texorpdfstring{ECMAScript support}{ECMAScript support}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1821}
...
Currently, ECMAScript 2018 is supported.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1822}{}\doxysubsection{\texorpdfstring{Invalid code handling}{Invalid code handling}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1822}
...
Strings may contain invalid escape sequences.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1823}{}\doxysubsection{\texorpdfstring{Limitations}{Limitations}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1823}
Tokenizing Java\+Script using regexes—in fact, \+\_\+one single regex\+\_\+—won’t be perfect. But that’s not the point either.

You may compare js\+Tokens with \href{http://esprima.org/}{\texttt{esprima}} by using {\ttfamily esprima-\/compare.\+js}. See {\ttfamily npm run esprima-\/compare}!\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1824}{}\doxysubsubsubsection{\texorpdfstring{Template string interpolation}{Template string interpolation}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1824}
...
Matching template string interpolations requires recursive balancing of {\ttfamily \{} and {\ttfamily \}}—something that Java\+Script regexes cannot do. Only one level of nesting is supported.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1825}{}\doxysubsubsubsection{\texorpdfstring{Division and regex literals collision}{Division and regex literals collision}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1825}
...
The above example is also correctly identified as division, because {\ttfamily e} is not a valid regex flag. I initially wanted to future-\/proof by allowing {\ttfamily \mbox{[}a-\/z\+A-\/Z\mbox{]}\texorpdfstring{$\ast$}{*}} (any letter) as flags, but it is not worth it since it increases the amount of ambigous cases. So only the standard {\ttfamily g}, {\ttfamily m}, {\ttfamily i}, {\ttfamily y} and {\ttfamily u} flags are allowed. This means that the above example will be identified as division as long as you don’t rename the {\ttfamily e} variable to some permutation of {\ttfamily gmiyus} 1 to 6 characters long.
...
If the end of a statement looks like a regex literal (even if it isn’t), it will be treated as one. Otherwise it should work as expected (if you write sane code).\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1826}{}\doxysubsubsubsection{\texorpdfstring{ES2018}{ES2018}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1826}
...
These things would be nice to do, but are not critical. They probably have to wait until the oldest maintained Node.\+js LTS release supports those features.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1827}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md1827}
