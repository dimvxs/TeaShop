...
\begin{center}
\leavevmode
\includegraphics[width=175pt]{dir_282f5d0f119bfbd848f2e84b2c479056_dep}
\end{center}
\end{figure}


\doxysubsection{Detailed Description}
\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1111}{}\doxysubsection{\texorpdfstring{cookie}{cookie}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1111}
...
Basic HTTP cookie parser and serializer for HTTP servers.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1112}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1112}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ cookie}

\end{DoxyCode}
\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1113}{}\doxysubsection{\texorpdfstring{API}{API}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1113}
...
\end{DoxyCode}
\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1114}{}\doxysubsubsection{\texorpdfstring{cookie.\+parse(str, options)}{cookie.\+parse(str, options)}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1114}
...
\end{DoxyCode}
\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1115}{}\doxysubsubsubsection{\texorpdfstring{Options}{Options}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1115}
{\ttfamily cookie.\+parse} accepts these properties in the options object.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1116}{}\doxysubsubsubsubsection{\texorpdfstring{decode}{decode}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1116}
...
The default function is the global {\ttfamily decode\+URIComponent}, wrapped in a {\ttfamily try..catch}. If an error is thrown it will return the cookie\textquotesingle{}s original value. If you provide your own encode/decode scheme you must ensure errors are appropriately handled.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1117}{}\doxysubsubsection{\texorpdfstring{cookie.\+serialize(name, value, options)}{cookie.\+serialize(name, value, options)}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1117}
...
\end{DoxyCode}
\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1118}{}\doxysubsubsubsection{\texorpdfstring{Options}{Options}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1118}
{\ttfamily cookie.\+serialize} accepts these properties in the options object.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1119}{}\doxysubsubsubsubsection{\texorpdfstring{encode}{encode}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1119}
...
The default function is the global {\ttfamily encode\+URIComponent}.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1120}{}\doxysubsubsubsubsection{\texorpdfstring{max\+Age}{max\+Age}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1120}
...
The \href{https://tools.ietf.org/html/rfc6265\#section-5.3}{\texttt{cookie storage model specification}} states that if both {\ttfamily expires} and {\ttfamily max\+Age} are set, then {\ttfamily max\+Age} takes precedence, but it is possible not all clients by obey this, so if both are set, they should point to the same date and time.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1122}{}\doxysubsubsubsubsection{\texorpdfstring{domain}{domain}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1122}
Specifies the value for the \href{https://tools.ietf.org/html/rfc6265\#section-5.2.3}{\texttt{{\ttfamily Domain} {\ttfamily Set-\/\+Cookie} attribute}}. When no domain is set clients consider the cookie to apply to the current domain only.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1123}{}\doxysubsubsubsubsection{\texorpdfstring{path}{path}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1123}
Specifies the value for the \href{https://tools.ietf.org/html/rfc6265\#section-5.2.4}{\texttt{{\ttfamily Path} {\ttfamily Set-\/\+Cookie} attribute}}. When no path is set, the path is considered the \href{https://tools.ietf.org/html/rfc6265\#section-5.1.4}{\texttt{"{}default path"{}}}.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1124}{}\doxysubsubsubsubsection{\texorpdfstring{http\+Only}{http\+Only}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1124}
Enables the \href{https://tools.ietf.org/html/rfc6265\#section-5.2.6}{\texttt{{\ttfamily Http\+Only} {\ttfamily Set-\/\+Cookie} attribute}}. When enabled, clients will not allow client-\/side Java\+Script to see the cookie in {\ttfamily document.\+cookie}.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1125}{}\doxysubsubsubsubsection{\texorpdfstring{secure}{secure}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1125}
Enables the \href{https://tools.ietf.org/html/rfc6265\#section-5.2.5}{\texttt{{\ttfamily Secure} {\ttfamily Set-\/\+Cookie} attribute}}. When enabled, clients will only send the cookie back if the browser has a HTTPS connection.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1126}{}\doxysubsubsubsubsection{\texorpdfstring{partitioned}{partitioned}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1126}
...
This is an attribute that has not yet been fully standardized, and may change in the future. This also means clients may ignore this attribute until they understand it. More information about can be found in \href{https://github.com/privacycg/CHIPS}{\texttt{the proposal}}.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1127}{}\doxysubsubsubsubsection{\texorpdfstring{priority}{priority}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1127}
...
More information about priority levels can be found in \href{https://tools.ietf.org/html/draft-west-cookie-priority-00\#section-4.1}{\texttt{the specification}}.\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1128}{}\doxysubsubsubsubsection{\texorpdfstring{same\+Site}{same\+Site}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1128}
...
\end{DoxyCode}
\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1130}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1130}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ test}

\end{DoxyCode}
\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1131}{}\doxysubsection{\texorpdfstring{Benchmark}{Benchmark}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1131}
...
\end{DoxyCode}
\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1132}{}\doxysubsection{\texorpdfstring{References}{References}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1132}
...
\end{DoxyItemize}\hypertarget{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1133}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_282f5d0f119bfbd848f2e84b2c479056_autotoc_md1133}
