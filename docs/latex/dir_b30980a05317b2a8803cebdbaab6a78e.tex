...
Directory dependency graph for set-\/cookie-\/parser\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=204pt]{dir_b30980a05317b2a8803cebdbaab6a78e_dep}
\end{center}
\end{figure}


\doxysubsection{Detailed Description}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2714}{}\doxysubsection{\texorpdfstring{set-\/cookie-\/parser}{set-\/cookie-\/parser}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2714}
...
(The output format is loosely based on the input format of \href{https://www.npmjs.com/package/cookie}{\texttt{https\+://www.\+npmjs.\+com/package/cookie}})\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2717}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2717}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ -\/-\/save\ set-\/cookie-\/parser}

\end{DoxyCode}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2718}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2718}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2719}{}\doxysubsubsection{\texorpdfstring{Get array of cookie objects}{Get array of cookie objects}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2719}
...
\end{DoxyCode}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2720}{}\doxysubsubsection{\texorpdfstring{Get map of cookie objects}{Get map of cookie objects}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2720}
...
\end{DoxyCode}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2721}{}\doxysubsubsection{\texorpdfstring{Creating a new, modified set-\/cookie header}{Creating a new, modified set-\/cookie header}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2721}
...
See a real-\/world example of this in \href{https://github.com/nfriedly/node-unblocker/blob/08a89ec27274b46dcd80d0a324a59406f2bdad3d/lib/cookies.js\#L67-L85}{\texttt{unblocker}}\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2722}{}\doxysubsection{\texorpdfstring{Usage in React Native (and with some other fetch implementations)}{Usage in React Native (and with some other fetch implementations)}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2722}
...
Note that the {\ttfamily fetch()} spec now includes a {\ttfamily get\+Set\+Cookie()} method that provides un-\/combined {\ttfamily Set-\/\+Cookie} headers. This library will automatically use that method if it is present.\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2723}{}\doxysubsection{\texorpdfstring{API}{API}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2723}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2724}{}\doxysubsubsection{\texorpdfstring{parse(input, \mbox{[}options\mbox{]})}{parse(input, \mbox{[}options\mbox{]})}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2724}
Parses cookies from a string, array of strings, or a http response object. Always returns an array, regardless of input format. (Unless the {\ttfamily map} option is set, in which case it always returns an object.)\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2725}{}\doxysubsubsection{\texorpdfstring{parse\+String(individual\+Set\+Cookie\+Header, \mbox{[}options\mbox{]})}{parse\+String(individual\+Set\+Cookie\+Header, \mbox{[}options\mbox{]})}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2725}
Parses a single set-\/cookie header value string. Options default is {\ttfamily \{decode\+Values\+: true\}}. Used under-\/the-\/hood by {\ttfamily parse()}. Returns an object.\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2726}{}\doxysubsubsection{\texorpdfstring{split\+Cookies\+String(combined\+Set\+Cookie\+Header)}{split\+Cookies\+String(combined\+Set\+Cookie\+Header)}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2726}
It\textquotesingle{}s uncommon, but the HTTP spec does allow for multiple of the same header to have their values combined (comma-\/separated) into a single header. This method splits apart a combined header without choking on commas that appear within a cookie\textquotesingle{}s value (or expiration date). Returns an array of strings that may be passed to {\ttfamily parse()}.\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2727}{}\doxysubsection{\texorpdfstring{References}{References}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2727}
...
\end{DoxyItemize}\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2728}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2728}
